...
class some_class:
    def input(self,a="I"):
        if a=="I":
            ...
            self.sent=input("Enter Model: ")
    def disp(self):
        print (self.name+" "*(20-len(self.name)),"|\t",self.make+" "*(20-len(self.make)),"\t|",self.sent+ ' '*(20-len(self.sent))+'\t|',self.serial+" "*(8-len(self.serial)),"|\t",self.date,sep=" ")
...
_________________________________________________________________________________________________
""")
    print("NAME"+" "*(20-len("name")),"|\t","MAKE"+" "*(20-len('make')),"\t|","MODEL"+ ' '*(20-len('MODEL'))+'\t|',"SERIAL"+" "*2,"|\t","DATE")
    print("""-------------------------------------------------------------------------------------------------
""")
def create(a="wb"):
    if a=="wb":
...
Please recheck the root directory""")
        ...
        try:
            ...
            if k==0:print ("Serial no. not found..")
